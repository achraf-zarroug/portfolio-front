    ...
    <nav class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex justify-between items-center py-6">
        ...
        <div class="hidden md:flex items-center space-x-8">
          ...
          <!-- Contact Button (as RouterLink) -->
          <RouterLink
            to="/contact"
            class="bg-gradient-to-r from-teal-500 to-teal-600 hover:from-teal-600 
                   hover:to-teal-700 text-white px-6 py-2.5 rounded-full text-sm font-medium 
      ...
      <div v-if="mobileMenuOpen" class="md:hidden">
        <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3 border-t">
          ...
          <RouterLink
            to="/contact"
            @click="mobileMenuOpen = false"
            class="block bg-teal-500 hover:bg-teal-600 text-white px-4 py-2 rounded-md text-base font-medium mt-2 text-center transition"
          >
            Contact
          </RouterLink>
        </div>
