  ...
  <div class="p-6">
    ...
    <div class="flex space-x-4">
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        class="inline-flex items-center px-4 py-2 border border-teal-500 text-teal-600 text-sm font-medium rounded-md hover:bg-teal-500 hover:text-white transition-colors"
      >
